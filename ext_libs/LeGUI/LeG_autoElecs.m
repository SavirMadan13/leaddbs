...
buildTag = '2026-03-09-chainfit-v13-port9';
fprintf('[AutoElec] Build: %s | File: %s\n', buildTag, mfilename('fullpath'));
...
if strcmp(detectorMode, 'chainhybrid')
    fprintf('[AutoElec] Detector mode: chainhybrid\n');
...
elseif strcmp(detectorMode, 'countguided') || strcmp(detectorMode, 'chainfit')
    fprintf('[AutoElec] Detector mode: %s\n', detectorMode);
...
elseif strcmp(detectorMode, 'chainoptimization')
    fprintf('[AutoElec] Detector mode: chainoptimization\n');

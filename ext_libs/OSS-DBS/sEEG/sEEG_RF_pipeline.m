...
% Inputs
sEEG_table = '/Users/savirmadan/Documents/Localizations/SEEG/LeguiMerge2/derivatives/leaddbs/sub-LeGUITestPt/stimulations/LeGUITestPt.tsv';
sEEG_stim_protocols = {'/Users/savirmadan/Documents/Localizations/SEEG/LeguiMerge2/derivatives/leaddbs/sub-LeGUITestPt/stimulations/LeGUITestPt.csv'};
anchor = '/Users/savirmadan/Documents/GitHub/leaddbs/templates/space/MNI152NLin2009bAsym/t2.nii';
reslice2segmask = true; % if true, all VTRs are stored in the same voxel space defined by segmask
                        % this is handy when voxelwise operations are used
                        % but each VTR nii is > 100 MBs
...
warp2MNI = false;   % warp from the anchor space to MNI
transform = '/Users/savirmadan/Documents/Localizations/SEEG/LeguiMerge2/derivatives/leaddbs/sub-LeGUITestPt/normalization/transformations/sub-LeGUITestPt_from-MNI152NLin2009bAsym_to-anchorNative_desc-ants.nii.gz';      % from native to MNI, you need the opposite warp, i.e. from-MNI152NLin2009bAsym_to-anchorNative
                                                                                 % IMPORTANT: make sure ants is mentioned in the name and use single quote

Segment_SVD = true;
images = dir_without_dots('/Users/savirmadan/Documents/Localizations/SEEG/LeguiMerge2/derivatives/leaddbs/sub-LeGUITestPt/preprocessing/anat/sub-*');

% autopath
segmaskFile = '/Users/savirmadan/Documents/GitHub/leaddbs/templates/space/MNI152NLin2009bAsym/segmask.nii';
...
%         env.system(['python ', ea_path_helper(OSS_sEEG_script), ' ', ea_path_helper(sEEG_table), ' ',ea_path_helper(sEEG_stim_protocols{elec,1}),  ' ',Stim_Mode, ' ', num2str(elec)])
        cmd = strjoin({ ...
            'python', ea_path_helper(OSS_sEEG_script), ...
            ea_path_helper(sEEG_table), ...
            ea_path_helper(sEEG_stim_protocols{elec,1}), ...
            num2str(elec), ...
            Stim_Mode ...
            }, ' ');
